...
4. Los organizadores de un acto electoral solicitaron realizar un programa para 
...
void main()
{
    ...
    printf("Votos candidato1 %d tiene un porcentaje del %.2f\n", voto1, porcV1);
    printf("Votos candidato2 %d tiene un porcentaje del %.2f\n", voto2, porcV2);
    printf("Votos candidato3 %d tiene un porcentaje del %.2f\n", voto3, porcV3);
    printf("Votos candidato4 %d tiene un porcentaje del %.2f\n", voto4, porcV4);
    printf("Votos candidato5 %d tiene un porcentaje del %.2f", voto5, porcV5);
}
